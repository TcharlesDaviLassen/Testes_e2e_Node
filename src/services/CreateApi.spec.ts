...
describe("InMemoryApiRepository service => ", () => {
    ...
    it("Test data Api whith not invalid title", async () => {
        ...
        const createApi = new CreateApi(inMemoryApiRepository); // Envia pro Service o objeto com o formato exato de um repoitorio.
        // create: async (data) => { }
        // });
        ...
        // Que espera receber um item registrado da re gra de interface, que ela seja igual a um array contendo um objeto, e nesse objeto contenha um titulo.
    ...
    it("Test data Api with invalid title", async () => {
        ...
        // Caso esteja em branco irá retornar um erro, colocar o rejects porque a promise vai gerar um erro
